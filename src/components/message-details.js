    ...
    render() {
        ...
        for(let item in this.props.msgDetails){
            if(isNaN(item)){
                ...
                listContent.push(
                    <tr key={cnt}
                        className="text-dark-brw text-start">
        ...
        return (
            <div>
                <Table striped bordered hover className="text-left w-100 border-dark-brw">
                    <thead>
                        <tr>
                            <th colSpan="2"
                                className="text-center text-dark-brw">                                
                                Message details
                            </th>
                        </tr>
                    </thead>
                ...
                <div className="w-100 text-center">
                    <Button variant={"outline-light rounded-pill text-dark-brw border-dark-brw me-2"}
                        className="float-left"
                        onClick={this.delete.bind(this)}>
                        Delete
                    </Button>
                    <Button variant={"outline-light rounded-pill text-dark-brw border-dark-brw"}
