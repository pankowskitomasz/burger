            ...
            <Container fluid className={"contact-form align-items-center p-0 py-5 d-flex minh-50vh " + this.props.classExt}>
                <Row className="mx-auto text-center w-100">
                    <Col xs={10} md={6} className="mx-auto p-0 d-flex align-items-center">
                        <Card className="mx-auto bg-form opacity-8 border-dark-brw shadow">
                            <Card.Header className="text-white text-start border-dark-brw bg-dark-brw">
                                Message sent!
                            </Card.Header>
                            <Card.Body className="text-center text-dark-brw p-5">
                                <p className="lead">Message was sent!</p>
                                <Button variant={"outline-warning rounded-pill border-dark-brw text-dark-brw"} onClick={this.hndBack.bind(this)}>
                                    back to Form
                                </Button>
                            </Card.Body>
                        </Card>
