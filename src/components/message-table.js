...
class MessageTable extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Table striped bordered hover className="text-start w-100 border-dark-brw">
                    <thead>
                        <tr className="text-dark-brw border-dark-brw">
                            <th>ID</th>
                            <th>Name</th>
                ...
                <div className="w-100 text-end">
                    <Button variant={"outline-light text-dark-brw border-dark-brw me-2"}
                        onClick={this.prevPage.bind(this)}>
                        &lt;
                    </Button>
                    <Button variant={"outline-light text-dark-brw border-dark-brw"}
