...
class StoryExt extends Component{
    render(){
        return(        
            <Container fluid className={"story-ext p-0 minh-50vh d-flex align-items-center py-3 "+this.props.classExt}>
